...
from app.api import admin, admin_ai, analytics, attempts, auth, groups, materials, moodle, public, skills, source_imports, tests, users
...
app.include_router(source_imports.router)
